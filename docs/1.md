...
Concerning the target variable, **hydrometry**, we found few missing data scattered throughout the timeseries, which we imputed with the moving average. 
...
This graph, instead, shows the distribution of missing data in the **temperature** variable (Florence).
