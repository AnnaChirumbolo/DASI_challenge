...
For this reason, we decided to filter out the dataset for the largest gap present in well 1 (77.5%). The distribution of the target variables post-filtering looks as follows. 
